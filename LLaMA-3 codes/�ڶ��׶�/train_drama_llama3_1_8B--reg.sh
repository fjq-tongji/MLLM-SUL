id="transformer_1221_llama_3.1_8B_reg"
if [ ! -f log/log_$id/infos_$id.pkl ]; then
start_from=""
else
start_from="--start_from log/log_$id"
fi
python train_drama_llama3_1_8B--reg.py --id transformer_llama3_1_8B  \
    ...
    --dropout_aoa 0.3 \
    --label_smoothing 0.2 \
    --pretrained_llama /share/home/tj21012/fjq/LLAMA/llama-3.1-8b/consolidated.00_1.pth  \
    --pretrained_reg  /share/home/tj21012/fjq/hus_2/drama_log/log_transformer_1218_llama3.1_8B/model-s1.pth  \
