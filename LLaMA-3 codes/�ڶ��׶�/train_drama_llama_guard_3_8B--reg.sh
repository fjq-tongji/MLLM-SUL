id="transformer_1221_llama_guard_3_8B_reg"
if [ ! -f log/log_$id/infos_$id.pkl ]; then
start_from=""
else
start_from="--start_from log/log_$id"
fi
python train_drama_llama_guard_3_8B--reg.py --id transformer_llama_guard_3_8B  \
    --caption_model transformer_llama_guard_3_8B  \
    --refine 1 \
    --refine_aoa 1 \
    --use_ff 0 \
    --decoder_type AoA \
    ...
    --dropout_aoa 0.3 \
    --label_smoothing 0.2 \
    --pretrained_llama /share/home/tj21012/fjq/LLAMA/llama-guard-3-8b/consolidated.00_1.pth  \
    --pretrained_reg  /share/home/tj21012/fjq/hus_2/drama_log/log_transformer_1220_llama_guard_3_8B/model-s1.pth  \
