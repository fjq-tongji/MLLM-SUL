...
class Decoder_llama(nn.Module):
    def __init__(self, layer):
        ...
        self.opt_model = '/data/fjq/blip-2/blip2-opt-2.7b-coco'
    ...
    def forward_inference(self, memory, tokens):
        ...
        inputs_embeds = self.opt_model.model.decoder.embed_tokens(tokens[:, 0:41])     ###tokens=(b,问题) -> (b,问题,2560)
        ...
        outputs = self.opt_model.generate(               ### (b,50)
            inputs_embeds=inputs_embeds, max_length=100, do_sample=True, top_p=0.95, temperature=0.5, repetition_penalty=1.0,
